...
export const StyledButton = styled.button`
  font-size: ${(p: ButtonProps) => (p.size === "small" ? "15px" : "16px")};
  font-weight: 600;
  color: ${theme.text.default};
  border-radius: 32px;
  padding: ${(p: ButtonProps) => (p.size === "small" ? "6px 12px" : "10px 16px")};
  ...
  cursor: pointer;
  -webkit-display: none;
  opacity: ${(p: ButtonProps) => (p.disabled ? "0.6" : "1")};
  line-height: 1.2;
  ...
  &:active {
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${tint(theme.bg.border, -24)};
    transition: box-shadow 0.2s ease-in-out;
  }
`;
...
export const StyledPrimaryButton = styled(StyledButton)`
  ...
  &:focus {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.brand.alt, 0.24)};
  }

  &:active {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.brand.alt, 0.64)};
  }
`;

export const StyledWarnButton = styled(StyledPrimaryButton)`
  background-color: ${theme.warn.default};
  background-image: ${`linear-gradient(to bottom, ${theme.warn.default}, ${tint(theme.warn.default, -8)})`};
  ...
  &:focus {
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.warn.default, 0.24)};
  }
  &:active {
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.warn.default, 0.64)};
  }
`;
...
export const StyledWhiteButton = styled(StyledButton)`
  ...
  &:focus {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.bg.default, 0.24)};
  }
  &:active {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.bg.default, 0.64)};
  }
`;
...
export const StyledPrimaryOutlineButton = styled(StyledOutlineButton)`
  ...
  &:focus {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.brand.alt, 0.16)};
  }
  &:active {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.brand.alt, 0.48)};
  }
`;
...
export const StyledWhiteOutlineButton = styled(StyledOutlineButton)`
  ...
  &:focus {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.bg.default, 0.16)};
  }
  &:active {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.bg.default, 0.48)};
  }
`;
...
export const StyledHoverWarnOutlineButton = styled(StyledOutlineButton)`
  ...
  &:active {
    transition: box-shadow 0.2s ease-in-out;
    box-shadow: 0 0 0 2px ${theme.bg.default}, 0 0 0 4px ${hexa(theme.warn.default, 0.48)};
  }
`;
